...
public class EmployeeDB {
    public List<Employee> getAllEmployee()
    {
        ...
        try {
            ...
            while(rs.next())
            {
                ...
                int salaryrange = rs.getInt("Salaryrange");
                String address = rs.getString("Address");
                
                Employee e = new Employee(id, Name, age, position, salaryrange, address);
    ...
    public boolean addEmployee(Employee e)
    {
        try {
            ...
            cstmt.setString("position", e.getPosition());
            cstmt.setInt("salaryrange", e.getSalaryrange());
